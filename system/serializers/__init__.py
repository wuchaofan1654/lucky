...
from system.serializers.dept import DeptSerializer, DeptCreateUpdateSerializer, DeptImportSerializer
from system.serializers.dictionary import DictionarySerializer, DictionaryInitSerializer, \
    DictionaryCreateUpdateSerializer
from system.serializers.file_list import FileSerializer
...
from system.serializers.user import UserSerializer, UserProfileImportSerializer, UsersInitSerializer, \
    UserCreateSerializer, UserUpdateSerializer, UserInfoUpdateSerializer, ExportUserProfileSerializer
